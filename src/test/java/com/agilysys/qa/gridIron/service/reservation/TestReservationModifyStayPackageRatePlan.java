...
public class TestReservationModifyStayPackageRatePlan extends StayUIWrappers {
    ...
    public void beforeClass() {
        ...
        masterObject = new CreatePopulatedProperty().createBuilding()
                .createProperty("StayAutomation " + tenant.getTenantCode(), tenant.getTenantCode(), propertycode,
                        propertycode)
                .createPaymentMethodAllCC().createRoomTypes(2).createRooms(6).createCategories(1).createSubCategories(1)
                .createItems(10).createReservation(1).createTravelAgents(1).create();
        ...
        InventoryItem inventoryItem = new CreateInventoryItem().create(masterObject.getCategories().get(0),
                masterObject.getSubCategories().get(0), RandomHelper.getRandomInt(10, 99), masterObject.getProperty());

        components.add(new BuilderComponent(transactionItems.stream().filter(x -> x.getName().equalsIgnoreCase("Nightly Room Charge")).findFirst().get()
                , new BigDecimal(RandomHelper.getRandomInt(1, 10)),
    ...
    @Test
    @TestCase(ids = {"RST-2035", "RST-8607"})
    public void testModifyStayPackageRatePlanToRegularRatePlan() {
        builderBookReservation
                .setRandomPersonalDetails()
                .setRandomPhoneNumber()
                .setRandomRateSnapshots(2, packageRatePlan, masterObject.getRoomTypes().get(0), propertyDate)
        ...
        PFReservationEstimatedCharges.expandPackage(propertyDate);
        ...
        builderBookReservation.getReservationCreateRequest().getRateSnapshots().forEach((rateSnapshot) -> {
            VerifyReservation.verifyEstimatedChargesLineItemAmount(rateSnapshot.getDate(), rateSnapshot.getRoomTypeCode(),
                    regularRatePlanBasePrice);
        });
    }

    @Test
    @TestCase(ids = {"RST-2021", "RST-8607"})
    public void testModifyStayPackageRatePlanByChangingRoomType() {
        builderBookReservation
                .setRandomPersonalDetails()
                .setRandomPhoneNumber()
    ...
    @Test
    @TestCase(id = "RST-2021")
    public void testModifyStayPackageRatePlanByExtendingDates() {
        ...
        PFReservationEstimatedCharges.loadEstimatedCharges();
        PFReservationSummary.setDepartureDate(propertyDate.plusDays(3));
        ...
        POModifyStayPanel.confirmModifyStay();
        POSearchInMainPage.goToReservation(builderBookReservation.getGuestProfile().getPersonalDetails().getLastName());
        VerifyReservation.verifyPackageRoomChargeAmount(rateSnapshot.getDate(), rateSnapshot.getRoomTypeCode(), packageRatePlanBasePrice);
    }

    @Test
    @TestCase(id = "RST-2122")
    public void testModifyStayPackageRatePlanByShorteningDates() {
        builderBookReservation
                .setRandomPersonalDetails()
                .setRandomPhoneNumber()
                .setRandomRateSnapshots(2, packageRatePlan,
        ...
        PFReservationEstimatedCharges.loadEstimatedCharges();
        PFReservationSummary.setDepartureDate(propertyDate.plusDays(1));
        PFReservationSummary.clickSaveReservation();
    ...
    @Test
    @TestCase(id = "RST-3947")
    public void testModifyStayPackageRatePlanByChangeToAnotherDates() {
        builderBookReservation
                .setRandomPersonalDetails()
                .setRandomPhoneNumber()
                .setRandomRateSnapshots(2, packageRatePlan,
        ...
        PFReservationSummary.clickSaveReservation();
        POModifyStayPanel.modifyStay(builderBookReservation.getReservationCreateRequest().getRateSnapshots(), true,
                propertyDate.plusDays(5));
        POModifyStayPanel.confirmModifyStay();
    ...
    @Test
    @TestCase(id = "RST-3957")
    public void testModifyStayPackageRatePlanByAdjustRate() {
        builderBookReservation
                .setRandomPersonalDetails()
                .setRandomPhoneNumber()
                .setRandomRateSnapshots(2, packageRatePlan,
    ...
    @Test
    public void testModifyStayPackageRatePlanWithCompRate() {
        builderBookReservation
                .setRandomPersonalDetails()
                .setRandomPhoneNumber()
                .setRandomRateSnapshots(2, packageRatePlan,
    ...
    @Test
    public void testModifyStayPackageRatePlanWithIssueComp() {
        builderBookReservation
                .setRandomPersonalDetails()
                .setRandomPhoneNumber()
                .setRandomRateSnapshots(2, packageRatePlan,
    ...
    @Test
    public void testModifyStayPackageRatePlanWithRedeemComp() {
        builderBookReservation
                .setRandomPersonalDetails()
                .setRandomPhoneNumber()
                .setRandomRateSnapshots(2, packageRatePlan,
